...
def calculate_metrics(n: pypsa.Network) -> pd.Series:
    ...
    buses_i = ac_buses.index
    countries = ac_buses.country.unique()
    price_columns = n.buses_t.marginal_price.columns
    relevant_columns = price_columns.intersection(buses_i.union(countries))
    prices = n.buses_t.marginal_price[relevant_columns]
