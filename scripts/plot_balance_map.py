...
if __name__ == "__main__":
    ...
    # Filter for buses that actually have a marginal price
    buses = n.buses_t.marginal_price.columns.intersection(buses)
    ...
    price = prices.groupby(n.buses.location).mean()
    ...
    if vmin == vmax:
        vmax += 1e-6  # Add a small epsilon to avoid plotting errors
